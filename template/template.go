...
const Text = `// This description file specifies the environment for a RoboCup 
...
//======WEST TEAM======
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim Equipo1
...
//======EAST TEAM======
robot EDU.gatech.cc.is.abstractrobot.SocSmallSim Equipo2
